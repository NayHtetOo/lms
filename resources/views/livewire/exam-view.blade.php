...
<body>
    <div class="min-h-full">
        ...
        {{-- <ol class="flex justify-center text-xs font-medium space-x-1">
            <li>
              <a href="#page1" class="block w-8 h-8 text-center border border-gray-100 rounded leading-8"> Prev </a>
            </li>
            <li>
              <a href="#page2" class="block w-8 h-8 text-center border border-gray-100 rounded leading-8"> Next </a>
            </li>
        </ol>
        ...
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div class="p-4 bg-slate-300 rounded-xl transform transition-all duration-300 shadow-4xl shadow-lg">
                ...
                <div>
                    {{ $this->trueOrfalse->links('pagination-links') }}
                </div>
