    ...
    <header class="">
        <div
            ...
            <div class="w-full h-full flex items-center">
                <div>
                    <span class="text-white uppercase">Online Course</span>
                    <p class="capitalize text-white text-3xl font-bold w-[400px] my-3">
                        sharpen your skills with professional online courses
                    </p>
                    <button class="bg-green-600 text-white py-2 px-3 rounded-md" type="button">Join Now</button>
                </div>
            </div>
